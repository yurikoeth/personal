...
const Contact = () => {
  ...
  useEffect(() => {
    ...
    const style = {
        container: 'hidden lg:flex bg-zinc-900 h-fit text-white',
        flexbox: 'flex h-fit justify-between w-full m-auto p-20 pt-10',
        formContainer: 'bg-black p-6 rounded-md mt-12 w-3/4 xl:w-1/2 h-fit',
  ...
  return (
    <div className={style.container}>
        <div data-aos="fade-left" className={style.flexbox}>
          ...
          <form 
            ...
            >
              ...
              <button className={style.button} value="submit" id="button" type="submit">Submit</button>
            </form>
          </div>
