...
const Contact = () => {
  ...
  useEffect(() => {
    ...
    const style = {
        container: 'md:hidden bg-zinc-900 h-fit text-white',
    ...
    <div className={style.container}>
        <div data-aos="flip-up" className={style.flexbox}>
          <div className={style.textContainer}>
            ...
            <p>I am currently looking for any new opportunities, and my inbox is always open. Whether you have a question or just want to say hi, I'll get back to you as soon as possible. I can't wait
              to hear from you!</p>
            </div>
          </div>
          <div className={style.formContainer}>
            <form className={style.form}>
              ...
              <button className={style.button} id="button" type="submit">Submit</button>
            </form>
          </div>
    </div>
  </div>
